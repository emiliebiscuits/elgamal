...
public class Crypto {
    ...
    public static void main(String[] args) {
        Elgamal e = new Elgamal(5,100,new Random());
        ...
        System.out.println("ordre de g = "+ e.ordre(e.getG()));
        ...
        System.out.println("chiffré : ("+e.getG().modPow(r, e.getP())+", "+h.modPow(r,e.getP()).multiply(m).mod(e.getP())+")");
        BigInteger res = h.modPow(r,e.getP()).multiply(m).mod(e.getP()).divide(e.getG().modPow(r, e.getP()).modPow(x, e.getP()));
